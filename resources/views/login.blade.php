                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">DIRESA JUNÍN</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Bienvenido al Sistema del Plan de Eliminación de la Malaria! 👋</h2>
                                <p class="card-text mb-2">Por favor inice sesión</p>
                                <form class="auth-login-form mt-2" action="login" method="POST">
									@csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">Usuario</label>
                                        <input class="form-control" id="login-email" type="text" name="name" placeholder="john@example.com" aria-describedby="" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Contraseña</label><a href="#"><small>Olvidé mi contraseña</small></a>
                                        </div>
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tabindex="4">Ingresar</button>
                                </form>
